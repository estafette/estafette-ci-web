<template>
    <div>
      <div class="m-3">
        <div class="row">
          <div class="col-12 col-md-8 col-lg mb-2">
      ...
      <div class="m-3">
          ...
          <div class="row rounded border p-2 mt-2 mr-0 mb-2 ml-0 font-weight-bold">
            <div class="col-6 col-xl-5">Pipeline</div>
            <div class="col-6 col-md-3 col-xl-1">Version</div>
            <div class="col-12 col-md-3 col-xl-1 d-none d-md-block">Status</div>
            <div class="col-4 col-md-3 col-xl-1 d-none d-xl-block">Branch</div>
            <div class="col-4 col-md-3 col-xl-1 d-none d-xl-block">Revision</div>
            <div class="col-4 col-md-3 col-xl-2 d-none d-xl-block">Commit(s)</div>
            <div class="col-6 col-md-3 col-xl-1 d-none d-xl-block">Built at</div>
          </div>
          ...
          <router-link v-for="pipeline in pipelines" v-bind:key="pipeline.id" :to="{ name: 'PipelineBuilds', params: { repoSource: pipeline.repoSource, repoOwner: pipeline.repoOwner, repoName: pipeline.repoName }}" tag="div" class="row rounded border pt-3 pr-2 pb-2 pl-2 mt-2 mr-0 mb-2 ml-0" :class="pipeline.buildStatus | bootstrapClass('border')">
              <div class="mb-2 col-6 col-xl-5">
                  <span class="text-muted d-none d-sm-inline">{{pipeline.repoSource}}/{{pipeline.repoOwner}}/</span><strong>{{pipeline.repoName}}</strong>
              </div>
              <div class="mb-2 col-6 col-md-3 col-xl-1">{{pipeline.buildVersion}}</div>
              <div class="mb-2 col-12 col-md-3 col-xl-1 align-middle">
              ...
              <div class="mb-2 col-4 col-md-3 col-xl-1">{{pipeline.repoBranch}}</div>
              <div class="mb-2 col-4 col-md-3 col-xl-1">{{pipeline.repoRevision | gitHash}}</div>
              <div class="mb-2 col-4 col-md-3 col-xl-2">
              ...
              <div class="mb-2 col-6 col-md-3 col-xl-1">{{pipeline.insertedAt | moment("calendar")}}</div>
              <div class="col-12"><div class="mt-3 mb-3 w-50 mx-auto border-bottom"></div></div>
              <div class="mb-2 col-12 col-xl-6 text-center">
                <div class="small text-muted mb-1" v-if="pipeline.labels">Labels</div>
              ...
              <div class="mb-2 col-12 col-xl-6 text-center">
                <div class="small text-muted mb-1" v-if="pipeline.targetVersions">Releases</div>
