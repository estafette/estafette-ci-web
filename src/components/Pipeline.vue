<template>
  ...
  >
    ...
    <div
      ...
      v-if="rowItem"
    >
      <div class="col-auto align-self-end mr-1">
        <div
          :class="[
            'row justify-content-center bg-light rounded-bottom pl-2'
          ]"
        ...
        >
          <div
            ...
            :class="[
              'rounded bg-white p-1 text-center mt-2 mr-2 mb-2'
            ]"
          >
            <div
            ...
            >
              {{ releaseTarget.name }}<router-link
                ...
                exact
                :class="[$options.filters.bootstrapClass(release.releaseStatus, 'badge'), 'badge ml-1 clickable']"
                tag="span"
        ...
        <div
          :class="[
            'row justify-content-end bg-light rounded-bottom pl-2'
          ]"
          v-else
        >
          &nbsp;
...
export default {
  ...
  computed: {
    ...
    colClassesReleases () {
      if (this.rowItem) {
        return 'col-12 text-left text-truncate text-truncate-fade'
      }
